...
public class Function {
    ...
    public static void glV3Normalize(float[] vecInOut) {
        ...
        float fScale = (float) Math.sqrt(vecInOut[0] * vecInOut[0] + vecInOut[1] * vecInOut[1] + vecInOut[2]
                * vecInOut[2]);
        if (fScale == 0)
            return;
    ...
    public static void glV3Cross(float[] v3OUT, float[] v3A, float[] v3B) {
        ...
        /*
         * v3OUT[0] = v3B[1]*v3A[2]-v3A[1]*v3B[2]; v3OUT[1] =
         * v3B[2]*v3A[0]-v3A[2]*v3B[0]; v3OUT[2] = v3B[0]*v3A[1]-v3A[0]*v3B[1];
         */
    ...
    /**
     * 三元量(位置v3Position)相减 注意,作为位置信息的参数不应该规格化
     * 
    ...
    public static void glV3Transform(float[] v3InOut, float[] mxXform) {
         ...
         * v3InOut[2]*mxXform[2]+v3InOut[3]*mxXform[3]; f1 =
         * v3InOut[0]*mxXform[4] + v3InOut[1]*mxXform[5] +
         * v3InOut[2]*mxXform[6]+v3InOut[3]*mxXform[7]; f2 =
         * v3InOut[0]*mxXform[8] + v3InOut[1]*mxXform[9] +
    ...
    public static void glV4Transform(float[] v4InOut, float[] mxXform) {
        if ((v4InOut.length != 4) || (mxXform.length != 16))
            throw new RuntimeException("err in glV3Transform");
        float f0, f1, f2, f3;
        f0 = v4InOut[0] * mxXform[0] + v4InOut[1] * mxXform[1] + v4InOut[2] * mxXform[2] + v4InOut[3] * mxXform[3];
        f1 = v4InOut[0] * mxXform[4] + v4InOut[1] * mxXform[5] + v4InOut[2] * mxXform[6] + v4InOut[3] * mxXform[7];
        f2 = v4InOut[0] * mxXform[8] + v4InOut[1] * mxXform[9] + v4InOut[2] * mxXform[10] + v4InOut[3] * mxXform[11];
        f3 = v4InOut[0] * mxXform[12] + v4InOut[1] * mxXform[13] + v4InOut[2] * mxXform[14] + v4InOut[3] * mxXform[15];
        v4InOut[0] = f0;
        v4InOut[1] = f1;
        v4InOut[2] = f2;
        v4InOut[3] = f3;
     ...
     * 测试通过,但与D3D里的同价函数比较后,两个出的矩阵是完全相反的,应该是左右手不同造成的 与GL相关旋转函数比较后一致
     */
    ...
    /**
     * 内部方法]] 考贝一份float[3]的 vector 注意参数
     */
    ...
    public static IntBuffer PushIntoIntBuffer(int[] data) {
        IntBuffer ib = null;
        ByteBuffer bb = ByteBuffer.allocateDirect(data.length * 4);// 4 =
                                                                   // Integer.SIZE/8
        bb.order(ByteOrder.nativeOrder());
        ib = bb.asIntBuffer();
        ib.put(data);
